...
<div class="imgntab-cnt">
    <div class="imgntabcnt-in imtabcnt-4">
        ...
        <div id="imgntabcnt-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner" role="listbox">
                ...
                <!-- Controls -->
                @if(!empty($previous))
                <a class="left carousel-control" style="left: 0px; top: 30%;" href="{{route('home.category',['id' => base64url_encode($previous),'category'=>base64url_encode($template->category_id)])}}" role="button" data-slide="prev">
                    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
                </a>
                @endif
                @if(!empty($next))
                <a class="right carousel-control" style="right: 0px; top: 30%;" href="{{route('home.category',['id' => base64url_encode($next),'category'=>base64url_encode($template->category_id)])}}" role="button" data-slide="next">
