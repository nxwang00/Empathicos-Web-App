...
<div class="imgntab-cnt imgntabdif-cnt imgntab3-cnt">
            ...
            <div class="imgntabcnt-item item active">
                <div class="imgntabcntitem-in">
                    <div class="row imgntabcnt-row">
                        <div class="col-md-6 col-sm-6 col-xs-12 imgntabcntimg-col">
                            <div class="imgntabcntimg-wrap imgntabcntimg-wrap3">
                                <div class="imgntabcntimg imgntabcntimg3">
                                     <img class="img-responsive" src="{{asset('storage/badge-templates/'.$value->image)}}" alt="{{$value->title}}" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 imgntabcnttext-col">
             ...
             <!-- Controls -->
            @if(!empty($previous))
            <a class="left carousel-control" href="{{route('badge.templates.show',['id' => base64url_encode($previous),'category'=>base64url_encode($template->badge_id)])}}" role="button" data-slide="prev">
                <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
            </a>
            @endif
            @if(!empty($next))
            <a class="right carousel-control" href="{{route('badge.templates.show',['id' => base64url_encode($next),'category'=>base64url_encode($template->badge_id)])}}" role="button" data-slide="next">
