    ...
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-striped custom-table table-bordered-r table-hover mb-0 datatable" id="admin_categories_table">
                    <thead>
                        <tr>
                            <th>
                                Name
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#admin_categories_table').DataTable({
            processing: true,
            serverSide: true,
            bPaginate     : true,
            ...
            columns:[
            {
                ...
                render: function(data, type, full, meta){
                    return `<h2 class="table-avatar">
                        <a href="/admin/categories/`+full.id+`"  >`
        ...
        $('#searchByStatus').change(function(){
            $('#admin_categories_table').DataTable().draw(true);
        });
