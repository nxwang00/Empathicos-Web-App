...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title"> Edit Audio Course </h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.app.dashboard')}}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.audio-course.index')}}">Audio Course</a></li>
            ...
            <div class="col-auto float-right ml-auto">
                ...
                <a href="{{ route('admin.audio-course.index') }}" class="btn btn-mb btn-danger "><i class="fa fa-close"></i> Cancel</a>
            </div>
        </div>
    </div>
    <!-- Page Header -->
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card mb-0">
               <form method="post"  class="form-horizontal create-category" id="create-category" enctype="multipart/form-data" action="{{route('admin.audio-courses.updatedata')}}" data-table='categories_table'>
                @csrf
                <div class="card-header">Edit Audio Course </div>
                 <div class="card-body">
                        <div class="row">
                            <div class="col-sm-8">
                             ...
                             <div class="col-sm-4">
                                @if(!empty($data->image))
                                <img src="<?php echo asset('project/storage/app/public/audio-course/images/'.$data->image);?>" width="200">
                                @endif
                                <div class="form-group">
                                 ...
                                 @if(!empty($data->audio))
                                <audio controls>
                                  <source src="{{asset('project/storage/app/public/audio-course/audio/'.$data->audio)}}" type="audio/ogg">
                                    Your browser does not support the audio element.
                                </audio>
                                @endif
                                <div class="form-group">
                                    <label for="card_pic">Select Audio</label>
