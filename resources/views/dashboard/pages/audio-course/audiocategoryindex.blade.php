...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-name"> All Audio Course Categories</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.app.dashboard')}}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.audio-course-category.index')}}">Audio Course Categories</a></li>
                    <li class="breadcrumb-item active" aria-current="page">
                        All Audio Course Categories
                    </li>
                </ul>
            </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#admin_card_categories_table').DataTable({
            ...
            order: [[ 0, 'desc' ]],
            ajax:{
                url: "{{ route('admin.audio-course-category.index') }}",
                serverMethod: 'post',
                data: function(data){
