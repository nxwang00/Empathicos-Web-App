...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title"> Edit Audio Course Category </h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.app.dashboard')}}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.audio-course-category.index')}}">Audio Course Category</a></li>
                    <li class="breadcrumb-item active" aria-current="page">
                        Edit Audio Course Category
                    </li>
                </ul>
            </div>
            <div class="col-auto float-right ml-auto">
                <!--<a href="{{ route('admin.audio-course.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>-->
                <a href="{{ route('admin.audio-course-category.index') }}" class="btn btn-mb btn-danger "><i class="fa fa-close"></i> Cancel</a>
            </div>
        </div>
    </div>
    <!-- Page Header -->
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card mb-0">
               <form method="post"  class="form-horizontal create-category" id="create-category" enctype="multipart/form-data" action="{{route('admin.audio-course-category.updatedata')}}" data-table='categories_table'>
                @csrf
                <div class="card-header">Edit Audio Course Category </div>
                 <div class="card-body">
                        <div class="row">
                            <div class="col-sm-8">
