...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title"> Create Audio Course </h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.app.dashboard')}}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.main-subcategories.index')}}">Audio Courses</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-0">
                <form method="post"  class="form-horizontal create-category" id="create-category" enctype="multipart/form-data" action="{{ route('admin.audio-course.store')}}" data-table='categories_table'>
                    @csrf
                    <div class="card-header">Create Audio Course</div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-8">
