...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title"> All Characters </h3>
                <ul class="breadcrumb">
            ...
            columns:[
            {
                ...
                render: function(data, type, full, meta){
                    return `<h2 class="table-avatar-r">
                        <a href="/admin/badges/`+full.id+`" class="avatar-r">
                            <img src="{{ asset('/storage/badges') }}/`+ data + `" class="img-thumbnail" alt="No image Found" width="100" >
                        </a>
                    </h2>`;
                },
            },
