...
<div class="content container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-0">
                {{ Form::model($template, array('route' => array('admin.templates.update', $template->id), 'method' => 'PUT','files' => true,'id' => 'create-card','class'=>'form-horizontal create-card','data-table'=>'cards_table')) }}
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                {!!Form::select('category', $categories,old('category', $template->category_id), ['class' => error_field($errors,'category'),'placeholder' => '-- Select Category --','readonly' => 'true','disabled' => 'true'])!!}
                                                {!!error_msg($errors,'category')!!}
                                                <input type="hidden" class="form-control" name="category" id="category" value="{{$template->category_id}}" />
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <img alt="{{$value->title}}" src="{{ asset('/storage/templates/'.$value->image) }}" width="100px">
                                            @endif
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <img alt="{{$value->title}}" src="{{ asset('/storage/templates/'.$value->second_image) }}" width="100px">
                                            @endif
                                        </div>
                                    </div>
                                    <div class="form-group">
