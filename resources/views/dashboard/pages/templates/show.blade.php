    ...
    <div class="page-header">
        <div class="row align-items-center">
            ...
            <div class="col-auto float-right ml-auto">
                ...
                <a href="{{ route('admin.templates.index') }}" class="btn btn-mb btn-danger "><i class="fa fa-close"></i> Close</a>
            </div>
        </div>
    </div>
    <!-- /Page Header -->
        ...
        <div class="col-md-12">
            <div class="card mb-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card" style="width: 18rem;">
                                ...
                                <img alt="{{$value->title}}" src="{{ asset('/storage/templates/'.$value->image) }}" class="card-img-top">
                                @endif
                                <div class="card-footer text-center">
                                    <p class="mb-0"><a href="{{route('admin.templates.show',$template->id)}}">{{$value->title}}</a> </p>
                ...
                <div class="card-footer">
                    <a href="{{ route('admin.templates.edit',$template->id) }} " class="btn btn-dark"><i class="fa fa-pencil"></i> Edit</a>
                </div>
            </div>
        </div>
    </div>
