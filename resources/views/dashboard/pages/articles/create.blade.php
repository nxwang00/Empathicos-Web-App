...
<div class="content container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-0">
                <form method="post"  class="form-horizontal create-article" id="create-article" enctype="multipart/form-data" action="{{ route('admin.articles.store')}}" data-table='articles_table'>
                    @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="img-thumbnail float-right">
                                            <img src="{{ asset('/storage/settings/logo/article.png') }}" width='150px'  height='150px' />
                                        </div>
                                    </div>
                                </div>
                            </div>
