    ...
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-striped custom-table table-bordered-r table-hover mb-0 datatable" id="admin_articles_table">
                    <thead>
                        <tr>
                            <th>
                                Image
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#admin_articles_table').DataTable({
            processing: true,
            serverSide: true,
            bPaginate     : true,
            ...
            columns:[
            {
                ...
                render: function(data, type, full, meta){
                    return `<h2 class="table-avatar-r">
                        <a href="/admin/articles/`+full.id+`" class="avatar-r">
                            <img src="{{ asset('/storage/articles') }}/`+ data + `" class="img-thumbnail" alt="No image Found" width="100">
                        </a>
                    </h2>`;
                },
            },
            {
                ...
                render: function(data, type, full, meta){
                    return `<h2 class="table-avatar">
                        <a href="/admin/articles/`+full.id+`"  >`
                            +full.title+` <span>`+full.created_at+`</span>
                        </a>
                    </h2>`;
                },
            },
        ...
        $('#searchByStatus').change(function(){
            $('#admin_articles_table').DataTable().draw(true);
        });
