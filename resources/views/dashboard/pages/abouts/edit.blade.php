...
<div class="content container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-0">
                {{ Form::model($about, array('route' => array('admin.abouts.update', $about->id), 'method' => 'PUT','files' => true,'id' => 'create-about','class'=>'form-horizontal create-about','data-table'=>'abouts_table')) }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="img-thumbnail float-right">
                                            <img src="{{ asset('/storage/abouts/'.$about->image) }}" width='150px'  height='150px' />
                                        </div>
                                    </div>
                                </div>
                            </div>
