...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-question"> All Faqs </h3>
                <ul class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-striped custom-table table-bordered-r table-hover mb-0 datatable" id="admin_faqs_table">
                    <thead>
                        <tr>
                            <th>
                                Question
...
<script type="text/javascript">
    $(document).ready(function(){
            ...
            columns:[
            {
                ...
                render: function(data, type, full, meta){
                    return `<h2 class="table-avatar">
                        <a href="/admin/faqs/`+full.id+`"  >`
                            +full.question+` <span>`+full.created_at+`</span>
                        </a>
                    </h2>`;
                },
            },
        ...
        $('#searchByStatus').change(function(){
            $('#admin_faqs_table').DataTable().draw(true);
        });
